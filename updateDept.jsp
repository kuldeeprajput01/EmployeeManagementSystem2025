...
<head>
  ...
  <style>
    ...
    button:hover {
      ...
      box-shadow: 0 12px 25px rgba(247, 151, 30, 0.4);
    }
...
<body>
  ...
  <div class="form-container">
    <div class="form-title"><i class="fa-solid fa-pen-to-square"></i> Update Department</div>
    <form action="updatingDept" method="post">
      ...
      <div class="form-group">
        ...
        <textarea id="deptDescription" name="discription" required></textarea>
      </div>
      <button type="submit"><i class="fa-solid fa-pen-to-square"></i> Update Department</button>
    </form>
